...
class TelegramController extends Controller
{
    public function getWebhookUpdates()
    {
        ...
        $wishes = [
            ['text' => 'Принесите мне Волшебный чай Алладина!', 'realWishText' => 'Волшебный чай Алладина', 'sweet' => true],
            ['text' => 'Я желаю Магический кофе Царя Друидов!', 'realWishText' => 'Магический кофе Царя Друидов', 'sweet' => true],
            ['text' => 'Хочу Заморскую шоколадку Царя Салтана!', 'realWishText' => 'Заморскую шоколадку Царя Салтана', 'sweet' => true],
