...
return [
    ...
    */
    'commands' => [
        ...
        App\Commands\NewHeroCommand::class,
        App\Commands\HeroSleepCommand::class,
        App\Commands\HeroWakeUpCommand::class,
        App\Commands\Wishes\TeaCommand::class,
        App\Commands\Wishes\CoffeeCommand::class,
        App\Commands\Wishes\HugsCommand::class,
    ],
];
